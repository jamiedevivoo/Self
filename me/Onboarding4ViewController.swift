...
class Onboarding4ViewController: OnboardingViewController {
    ...
    override func viewDidLoad() {
        ...
        welcomeLabel.text = "Welcome To Your Emotional Companion 4"
    ...
    @objc func onboardingNext(_ sender: Any) {
        ...
        let nextOnboardingViewController = Onboarding5ViewController()
